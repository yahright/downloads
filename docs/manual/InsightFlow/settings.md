...
設定には専用のショートカットや右クリック項目はありません。`Ctrl+P` でコマンドパレットを開き、「**Settings**」と入力して実行してください。
...
- **Key Bindings** — キーボードショートカットの割り当て
- **Function Keys** — ファンクションキーの割り当て
